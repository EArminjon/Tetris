...
** Last update Fri Mar 17 09:09:37 2017 Enguerrand Arminjon
*/
...
char	**init_map_game(char **map, t_debug *t_debug, int zero);
...
int	init_struct_prompt(t_tetris *tetris, int ac, char **av, char *str);
